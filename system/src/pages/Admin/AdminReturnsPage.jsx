...
export function AdminReturnsPage() {
  ...
  const returnsBase = paths.returnsList;
  ...
  const lookupByNumber = async () => {
    ...
    try {
      ...
      if (tid != null && Number.isFinite(Number(tid))) {
        navigate(`${returnsBase}/${Number(tid)}`);
      } else {
                ...
                {items.map((row, idx) => {
                  ...
                  return (
                    <tr
                      ...
                      onClick={() => rid != null && navigate(`${returnsBase}/${encodeURIComponent(String(rid))}`)}
                    >
