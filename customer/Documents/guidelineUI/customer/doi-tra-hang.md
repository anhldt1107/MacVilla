...
| `itemCount`                 | number   |
| `createdAt`                 | ISO 8601 |
| `approvedAt`, `completedAt` | ISO 8601 |
| `orderId`                   | number   |
| `orderCode`                 | string   |
...
| `imageUrlReturned`                                             | string |
| `variantIdExchanged`                                           | number |
| `skuExchanged`, `variantNameExchanged`, `productNameExchanged` | string |
| `imageUrlExchanged`                                            | string |
| `quantity`                                                     | number |
