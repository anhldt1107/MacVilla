...
Read-only danh sách nhân sự nội bộ cho **Admin / Manager / StockManager / Worker** dùng để **phân công Sales / Worker**, hiển thị người xử lý trên các view, hoặc tổng hợp KPI. Không sửa được ở endpoint này — quản lý user đầy đủ thuộc `AdminOnly` ([nguoi-dung-va-vai-tro.md](./nguoi-dung-va-vai-tro.md)).

**Auth:** **WarehouseStaff** (Admin, Manager, StockManager, Worker — Sales bị **403**).
