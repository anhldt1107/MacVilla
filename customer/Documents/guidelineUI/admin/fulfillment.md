...
| Method | Path | Mô tả |
| ------ | ---- | ----- |
| GET | `/api/admin/fulfillments` | Danh sách phân trang |
| GET | `/api/admin/fulfillments/{id}` | Chi tiết phiếu + đơn |
| PUT | `/api/admin/fulfillments/{id}/status` | Cập nhật trạng thái |
| PUT | `/api/admin/fulfillments/{id}/assign` | Gán worker |
| GET | `/api/admin/fulfillments/statuses` | Enum / danh sách trạng thái |
...
| Method | Path | Mô tả |
| ------ | ---- | ----- |
| POST | `.../fulfillments` | Tạo phiếu xuất cho đơn |
