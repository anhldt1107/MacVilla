...
export function AdminWarrantyTicketDetailPage() {
  ...
  const claimPath = (id) => `${warrantyList}/claims/${encodeURIComponent(String(id))}`;
              ...
              <CardContent className="space-y-3 text-sm">
                ...
                <div className="flex justify-between gap-4">
                  ...
                  <span className="text-right">
                    {oid != null ? (
                      <Link className="font-mono text-violet-700 hover:underline dark:text-violet-400" to={`${paths.ordersList}/${encodeURIComponent(String(oid))}`}>
                ...
                <div className="flex justify-between gap-4">
                  ...
                  <span className="font-mono text-right">
                    {ctid != null ? (
                      <Link className="text-violet-700 hover:underline dark:text-violet-400" to={`${paths.contractsList}/${encodeURIComponent(String(ctid))}`}>
                          ...
                          return (
                            ...
                            >
                              <td className="px-4 py-2.5 pl-6 font-mono text-xs">
                                {id != null ? (
                                  <Link className="font-semibold text-violet-700 hover:underline dark:text-violet-400" to={claimPath(id)}>
                                    #{id}
                                  </Link>
                                ) : (
                                  "—"
