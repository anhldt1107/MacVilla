...
| `ManagerOrAdmin` | `admin`, `Manager`                           | Duyệt báo giá / đổi trả, hủy đơn, assign-sales, refund, verify CK, điều chỉnh công nợ, báo cáo, staff-directory                      |
| `WarehouseStaff` | `admin`, `Manager`, `StockManager`, `Worker` | Fulfillment (`/api/admin/fulfillments`), giao dịch kho (`/api/admin/inventory-transactions`), tồn kho admin (`/api/admin/inventory`) |
...
- `GET /api/admin/reports/*`, `GET /api/admin/staff-directory`
